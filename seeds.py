...
if __name__ == '__main__':
	...
	with app.app_context():
		...
		user1 = User('Jack Smith', 'consumer', 'jacksmith@gmail.com', '23456789012', 'password1', 'salt1', datetime.date(2018,2,21), datetime.date(2018,2,20))
		user2 = User('Jane Doe', 'manager', 'janedoe@gmail.com', '34567890123', 'password2', 'salt2')
		...
		bis1 = Business('Google', 'Technology', '1600 Ampitheatre Parkway', 1, 'google@gmail.com', '12345678901', 37.421512, -122.084101, 1)
		db.session.add(bis1)
